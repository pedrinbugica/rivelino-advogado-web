      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <div className="text-center pt-6 pb-4 px-4 animate-in slide-in-from-top-4 duration-700 delay-200">
              ...
              <div className="relative w-[240px] h-[240px] sm:w-[260px] sm:h-[260px]">
                ...
                {services.map((service, index) => {
                  ...
                  return (
                    <div
                      key={service.name}
                      className="absolute group cursor-pointer animate-in zoom-in-50 slide-in-from-bottom-4 duration-700"
                      style={{
                        left: '50%',
                        top: '50%',
                    ...
                    >
                      <div className={`w-12 h-12 ${service.color} rounded-full flex items-center justify-center text-white shadow-lg group-hover:scale-125 group-hover:shadow-xl transition-all duration-400 ease-out relative overflow-hidden border border-white/20`}
