  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
          <div 
            className="relative bg-white rounded-3xl p-6 sm:p-8 w-full max-w-sm sm:max-w-md shadow-2xl animate-in zoom-in-90 slide-in-from-bottom-8 duration-700 ease-out max-h-[90vh] overflow-y-auto"
          ...
          >
            ...
            {/* Título com animação */}
            <div className="text-center mb-8 animate-in slide-in-from-top-4 duration-700 delay-200">
            ...
            <div className="relative w-72 h-72 sm:w-80 sm:h-80 mx-auto">
              {/* Centro da roda com ícone da balança */}
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-20 h-20 sm:w-24 sm:h-24 bg-law-gray-dark rounded-full flex items-center justify-center z-10 animate-in zoom-in-50 duration-1000 delay-500 shadow-xl">
                <Scale className="h-8 w-8 sm:h-10 sm:w-10 text-law-gold" />
              </div>
              ...
              {services.map((service, index) => {
                ...
                const radius = 100; // Ajustado para mobile
                ...
                return (
                  ...
                  >
                    <div className={`w-14 h-14 sm:w-16 sm:h-16 ${service.color} rounded-full flex items-center justify-center text-white shadow-xl group-hover:scale-125 group-hover:shadow-2xl transition-all duration-500 ease-out relative overflow-hidden`}>
                      {service.icon}
            ...
            <div className="text-center mt-6 animate-in fade-in-0 duration-500 delay-1000">
